    ...
    <div className='skipRewards-container'>
      <section>
        {/* <div className='column1'>
          ...
          >
            <div class='styles__ImageMask-sc-1mdyj2e-8 jKgaQR'></div>
            <div></div>
          </div>
        </div> */}
        <div>
            ...
            <div className='column2'>
              ...
              <div className='rewards-text'>
                <p>
                  ...
                  what you love: free food. Order, earn points, and start
                  getting rewarded now.
                </p>
                <p>
                  There are no sign-ups or monthly fees. To begin, all you need
                  is a Skip account. It’s that easy.
                </p>
              </div>
